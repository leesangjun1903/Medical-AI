...
$$\mathcal{L}_{\text{restore}} = \|R_\theta(D(x_0, t), t) - x_0\|_2 $$
...
$$x_T = D(x_0, T) = \mathcal{A}^\dagger \mathcal{P}(T) \mathcal{A} x_0 $$
...
$$\hat{x}_0^T = R_{\theta^{\text{EMA}}}(x_T, T) $$
...
$$\mathcal{L}_{\text{compose}} = \|x_0 - R_\theta(x_t, t)\|_2 $$
